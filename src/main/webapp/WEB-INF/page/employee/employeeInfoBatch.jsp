			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div id="excelCheckBox" class="box-content">
						<table id="excelBox" class="table table-striped table-bordered">
							<thead>
								<tr>
									<label><input type="checkbox" name="HSBC Staff ID" />HSBC
										Staff ID&nbsp;&nbsp;</label>
									<label><input type="checkbox" name="LOB" />LOB&nbsp;&nbsp;</label>
									<label><input type="checkbox" name="Staff Name" />Staff
										Name&nbsp;&nbsp;</label>
									<label><input type="checkbox" name="LN" />LN&nbsp;&nbsp;</label>
									<label><input type="checkbox" name="Staff Region" />Staff
										Region&nbsp;&nbsp;</label>
									<label><input type="checkbox"
										name="Staff Location (country)" />Staff Location
										(country)&nbsp;&nbsp;</label>
									<label><input type="checkbox"
										name="Location Type (HSBCOffice/ODC)" />Location Type
										(HSBCOffice/ODC)&nbsp;&nbsp;</label>
									<label><input type="checkbox"
										name="Onshore or Offshore" />Onshore or Offshore&nbsp;&nbsp;</label>
									<label><input type="checkbox" name="HSBC Dept">HSBC
										Dept&nbsp;&nbsp;</label>
									<label><input type="checkbox" name="HSBC Sub Dept" />HSBC
										Sub Dept&nbsp;&nbsp;</label>
									<label><input type="checkbox" name="HSBC Manager" />HSBC
										Manager&nbsp;&nbsp;</label>
									<label><input type="checkbox" name="Project Name" />Project
										Name&nbsp;&nbsp;</label>
									<label><input type="checkbox" name="SOW#" />SOW#&nbsp;&nbsp;</label>
									<label><input type="checkbox" name="SOW# Expired Date" />SOW#
										Expired Date&nbsp;&nbsp;</label>
									<label><input type="checkbox"
										name="Staff Category(CATG/CATB)" />Staff
										Category(CATG/CATB)&nbsp;&nbsp;</label>
									<label><input type="checkbox"
										name="Engagement Type (T&M/FixedCost)" />Engagement Type
										(T&M/FixedCost)&nbsp;&nbsp;</label>
									<label><input type="checkbox" name="HSBC DOJ" />HSBC
										DOJ&nbsp;&nbsp;</label>
									<label><input type="checkbox"
										name="Experience on HSBC account in Months" />Experience on
										HSBC account in Months&nbsp;&nbsp;</label>
									<label><input type="checkbox" name="Graduation Date" />Graduation
										Date&nbsp;&nbsp;</label>
									<label><input type="checkbox"
										name="Total Experience in Months" />Total Experience in
										Months&nbsp;&nbsp;</label>
									<label><input type="checkbox" name="MSA Role" />MSA
										Role&nbsp;&nbsp;</label>
									...
									<label><input type="checkbox"
										name="Resource Status (Active/Terminated)" />Resource Status
										(Active/Terminated)&nbsp;&nbsp;</label>
									<label><input type="checkbox"
										name="If terminated mention LWD" />If terminated mention
										LWD&nbsp;&nbsp;</label>
									<label><input type="checkbox"
										name="Reason for Termination" />Reason for
										Termination&nbsp;&nbsp;</label>
									<label><input type="checkbox" name="E-HR" />E-HR&nbsp;&nbsp;</label>
									<label><input type="checkbox" name="AM" />AM&nbsp;&nbsp;</label>
									<label><input type="checkbox" name="CS Dept" />CS
										Dept&nbsp;&nbsp;</label>
								</tr>
							</thead>
							<tbody>
				...
				<div class="modal-content">
					...
					<div id="excelCheckBox" class="box-content">
						<form id="modifyForm" method="post" class="form-horizontal">
						    <div class="group">
							<label class="col-sm-2 control-label" style="width:30%;">Staff Name</label>
						    ...
						    <br /> <br /> <br />
							<div class="group">
								<label class="col-lg-2 control-label" style="width:30%;">Modify
									class</label>
							...
							<div style="display: none" id="projectProperties">
								<br /> <br /> <br />
								<div class="group">
									<label class="col-sm-2 control-label" style="width:30%;">Project Name</label>
									<div class="col-sm-4" style="width:60%;">
								...
								<br /> <br /> <br />
								<div class="group">
									<label class="col-sm-2 control-label" style="width:30%;">SOW#</label>
									<div class="col-sm-4" style="width:60%;">
								...
								<br /> <br /> <br />
								<div class="group">
									<label class="col-sm-2 control-label " style="width:30%;">SOW# Expired Date</label>
								...
								<br /> <br /> <br />
								<div class="group">
									<label class="col-lg-2 control-label" style="width:30%;">Engagement Type</label>
										<div class="col-lg-4" style="width:60%;">
							...
							<div style="display: none" id="humanRole">
								<br /> <br /> <br />
								<div class="group">
									<label class="col-lg-2 control-label" style="width:30%;">MSA Role</label>
										<div class="col-lg-4" style="width:60%;">
								...
								<br /> <br /> <br />
								<div class="group">
										<label class="col-lg-2 control-label" style="width:30%;">Skills/Technology</label>
										<div class="col-lg-4" style="width:60%;">
								...
								<br /> <br /> <br />
								<div class="group">
									<label class="col-lg-2 control-label" style="width:30%;">Staff Region</label>
										<div class="col-lg-4" style="width:60%;">
								...
								<br /> <br /> <br />
								<div class="group">
									<label class="col-sm-2 control-label" style="width:30%;">Bill
										Rate</label>
									<div class="col-sm-4" style="width:60%;">
							...
							<div style="display: none" id="departmentModify">
								<br /> <br /> <br />
								<div class="group">
									<label class="col-lg-2 control-label" style="width:30%;">HSBC Dept</label>
										<div class="col-lg-4" style="width:60%;">
								...
								<br /> <br /> <br />
								<div class="group">
									<label class="col-lg-2 control-label" style="width:30%;">HSBC Sub Dept</label>
										<div class="col-lg-4" style="width:60%;">
								...
								<br /> <br /> <br />
								<div class="group">
									<label class="col-sm-2 control-label" style="width:30%;">HSBC
										Manager</label>
									<div class="col-sm-4" style="width:60%;">
